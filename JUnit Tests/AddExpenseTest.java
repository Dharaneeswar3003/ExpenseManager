...
public class AddExpenseTest extends ApplicationTest {
    ...
    public void testAddExpenseWithMultipleCategories() {
        ...
        // Verify that only one category is selected at a time due to single-selection logic
       
    }

    @Test
    public void testClearFieldsAfterSubmit() {
        // Fill in valid input and submit
        clickOn("#purposeField").write("Entertainment");
        clickOn("#SumField").write("75.0");
        clickOn("#datePicker").write("5/2/2024");
        clickOn("#othersBox");
        clickOn("#submitButton");
